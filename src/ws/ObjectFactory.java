...
public class ObjectFactory {
    ...
    private final static QName _RegisterArg0_QNAME = new QName("", "arg0");
    ...
    public JAXBElement<byte[]> createRegisterArg0(byte[] value) {
        return new JAXBElement<byte[]>(_RegisterArg0_QNAME, byte[].class, Register.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createPutArg0(byte[] value) {
        return new JAXBElement<byte[]>(_RegisterArg0_QNAME, byte[].class, Put.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetArg0(byte[] value) {
        return new JAXBElement<byte[]>(_RegisterArg0_QNAME, byte[].class, Get.class, ((byte[]) value));
    }
